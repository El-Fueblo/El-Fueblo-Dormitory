...
<div class="container">
  <div class="row">
    <div class="col-sm-12">
    <?php if($show == 'success') { ?> 
        <h3>El Fueblo Dormitory Installed Successfully. Please remove install folder from root directory.</h3>
    <?php } else { ?>
        <h3>Error while installing El Fueblo Dormitory. Please contact support.</h3>
    <?php } ?>
    </div>
  </div>
</div>
