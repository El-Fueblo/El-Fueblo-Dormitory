...
<div class="wrapper">
  ...
  <aside class="main-sidebar elevation-4 sidebar-light-indigo">
    ...
    <img src="<?php echo base_url(); ?>assets/backend/dist/img/dhpms_logo.png" alt="DHPMS Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">El Fueblo Dormitory</span>
    </a>
    <div class="sidebar">
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <h3 class="text_center">El Fueblo Dormitory</h3><hr/>
        <p class="floatright"><?php echo $lang['version']; ?>: <b><?php echo $options['app_version']; ?></b></p><br><br>
        &copy; A Product of BSIT Technologies.<br>
        <img src="<?php echo base_url(); ?>assets/backend/dist/img/" class="text_center width20">
      </div>
